...
Note: Authentication is required for creating, joining, or managing communities.
...
## D. Community Management Endpoints (`/api/communities/{communityId}/admin`)
...
## E. Community Forum Endpoints (`/api/communities/{communityId}/forums`)
...
## F. Community Governance Endpoints (`/api/communities/{communityId}/governance`)

Note: Specific governance mechanisms and associated endpoints will depend on the chosen `governanceModel` for the community.

### 1. Community Governance Models

Specific governance mechanisms (e.g., voting, proposals) might have dedicated sub-endpoints depending on the chosen model.

* `GET /api/communities/{communityId}/governance/settings`

Specific governance mechanisms (voting, proposals) will have dedicated endpoints detailed in a separate governance API specification if needed.

## G. Resource Sharing Endpoints (`/api/communities/{communityId}/resources`)

Resource sharing endpoints will be specified as Resource Sharing features are further defined in Community Mode.

II. Community Governance Models
