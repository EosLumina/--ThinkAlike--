...
frontend URL (e.g., `/settings/connected-services?success=true&service={serviceId}`).
...
*   **`UserExternalToken`**: Database model to store encrypted `access_token`, `refresh_token`, `expires_at`,
