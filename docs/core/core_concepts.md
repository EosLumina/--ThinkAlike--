...
Refer to the [`Master Reference`](./master_reference.md) for formal definitions and the [`Glossary`](./glossary.md) for quick look-ups. For the underlying philosophy, see the [`Manifesto`](./manifesto/manifesto.md).
...
* **See Also:** [`Enlightenment 2.0 Principles`](./enlightenment_2_0/enlightenment_2_0_principles.md), [`Manifesto`](./manifesto/manifesto.md)
...
* **See Also:** [`Enlightenment 2.0 Principles`](./enlightenment_2_0/enlightenment_2_0_principles.md), [`Ethical Guidelines`](./ethics/ethical_guidelines.md)
...
* **In ThinkAlike:** This influences:
  ...
  * Our preferred development methodology, **Swarming Coding** (see [`CONTRIBUTING.md`](./contributing.md)), also reflects these principles through its emphasis on real-time collaboration, shared ownership, and reduced hierarchy in the coding process.
* **See Also:** [`Project Ethos`](./ethics/ethos.md), [`Manifesto`](./manifesto/manifesto.md), [`Enlightenment 2.0 Principles`](./enlightenment_2_0/enlightenment_2_0_principles.md), [`Community Mode Spec`](../architecture/modes/community_mode/community_mode_spec.md)
...
* **In ThinkAlike:**
  * **Fostering Literacy:** Features like the [`DataTraceability`](../components/ui_components/datatraceability_component_spec.md) component and [`AI Transparency Log`](../guides/developer_guides/ai/ai_transparency_log.md) actively help users understand how algorithms work and how their data is used, building crucial digital literacy.
