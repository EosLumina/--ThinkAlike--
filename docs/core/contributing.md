...
* **Code:** Contribute to the frontend (React), backend (Python/FastAPI), or AI models. We strive for "Perfect Coding" - code that is not only functional but also ethically sound, transparent, and well-tested. This includes:
...
* **UI/UX Design:** Help design and improve the user interface and user experience, focusing on **UI as a Validation Framework** and **Data Transparency:**
...
* **Documentation:** Improve the project documentation, write guides, and create onboarding materials, ensuring **clarity, accuracy, and accessibility** for all contributors and users:
...
* **Testing:** Help ensure the quality, security, and ethical integrity of the platform through rigorous testing:
...
* **AI Model Development:** Contribute to the development, training, and ethical validation of AI models, ensuring **transparency, accountability, and user empowerment** in AI implementations:
...
* **Ethical and Security Expertise:** Help ensure the project adheres to its ethical principles and security best practices, contributing to a **"Security by Transparency"** approach:
...
* **Community Engagement:** Help grow and support the ThinkAlike community, fostering a welcoming and collaborative environment:
...
* **`[optional scope]`:** The scope could be anything specifying the area of the commit change. For example `ui`, `api`, `database`, `auth`, `matching-algorithm`, `docs-onboarding`, etc.
...
* **`[optional body]`:** A longer commit body explaining the context and details of the commit. Use bullet points for clarity if needed.

* **`[optional footer(s)]`:** Footers can be used to reference issues, breaking changes, or other metadata. Example: `Fixes #123`, `BREAKING CHANGE: API endpoint /users changed response format`
...
This commit implements the core value-based matching algorithm, incorporating ethical weighting and user control features as outlined in the Architectural Design Specs.

- Prioritizes Value Nodes in matching.
- Allows users to customize value importance.
- Integrates with DataTraceability.jsx for transparent visualization.
```

```
docs: Update CONTRIBUTING.md with detailed contribution guidelines

This commit updates the CONTRIBUTING.md file to provide more comprehensive and actionable guidelines for new contributors, including detailed steps for code contribution, testing, and documentation.
```

```
fix(ui): Resolve layout issue on mobile devices in ProfileScreen

This commit fixes a layout issue in the ProfileScreen component that was causing elements to overlap on mobile devices.
...
* **Functionality:** Does the code implement the intended functionality correctly and efficiently?
* **Code Quality:** Is the code clean, readable, well-documented, and maintainable? Does it follow the Code Style Guidelines?
* **Ethical Compliance:** Does the code adhere to the Ethical Guidelines and promote data transparency, user empowerment, and ethical AI?
* **Testing:** Are there adequate unit tests, integration tests, and UI tests to validate the code and ensure its robustness? Are UI tests used effectively for data validation and workflow integrity?
* **Data Traceability:** Is data flow clear and traceable throughout the code? Are UI components used effectively to visualize data flow and validate data handling processes?
* **Security:** Does the code introduce any security vulnerabilities? Does it follow secure coding practices and data privacy protocols?
* **UI/UX:** Does the code integrate seamlessly with the UI/UX design? Does it enhance user experience and promote transparency and user control through the UI?

Be prepared to receive feedback on your code and to iterate on your contributions based on the review process. Code review is a collaborative and learning process, aimed at improving the overall quality and ethical integrity of the ThinkAlike project.

## Community and Communication

We believe in building a strong and supportive community around ThinkAlike. Please use the following channels for communication and collaboration:
...
* **Discord Server:** [Join our Discord Server](https://discord.gg/TnAcWezH) - For real-time communication, community discussions, Q&A, and general project updates.

We encourage open communication, respectful dialogue, and collaborative problem-solving within our community.

## Using AI Coding Assistants

We encourage the use of AI coding assistants like Copilot or Gemini to improve your coding efficiency and explore new implementation approaches. However, **always remember that you are ultimately responsible for the code you contribute.**

**Treat AI assistants as *tools to augment your own coding abilities*, not as replacements for your own understanding, critical thinking, and ethical judgment.**

**Best Practices for Using AI Assistants:**

* **Understand AI Suggestions:** Do not blindly accept AI-generated code. Always **carefully review, understand, and validate** every line of code suggested by AI assistants.
* **Test AI-Generated Code Rigorously:** Test AI-generated code even more thoroughly than code you write yourself. Pay close attention to edge cases, security vulnerabilities, and ethical implications. Use UI validation components to test and verify AI behavior.
* **Focus on Ethical Alignment:** Ensure that AI-generated code aligns with ThinkAlike's core ethical principles and does not introduce bias, opacity, or user manipulation. Use the Verification System and UI validation workflows to confirm ethical compliance.
* **Use AI for Repetitive Tasks and Boilerplate Code:** Leverage AI assistants to automate repetitive coding tasks, generate boilerplate code, and speed up development, but **retain human oversight and control over critical architectural and ethical decisions.**
* **Provide Clear and Specific Prompts:** To get the best results from AI assistants, provide clear, specific, and well-defined prompts that include:
  * **Context:** Explain the purpose and context of the code you want to generate.
  * **Specifications:** Reference relevant documentation files (like Architectural Design Specs, API docs, UI Style Guide) and clearly outline the desired functionality and data handling requirements.
  * **Ethical Considerations:** Explicitly state the ethical principles and data transparency requirements that the AI-generated code must adhere to.

**Example Prompts for AI Assistants (Tailored for ThinkAlike):**
...
* **Debugging (with ethical lens):**

    > "Explain this error: [Error message]. Analyze the code for potential ethical implications related to data handling or algorithmic bias. Here's the code: [Paste code]"

* **To write a commit message (following Conventional Commits and ethical considerations):**
